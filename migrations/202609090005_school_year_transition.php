...
return new class () implements Migration {
    ...
    public function up(PDO $pdo): void
    {
        ...
        $pdo->exec(
            ...
            . 'UNIQUE KEY uq_school_year_reminder (source_school_year_id, target_school_year_id, student_id, parent_contact_id, reminder_key),'
            ...
            . 'CONSTRAINT fk_school_year_reminder_parent FOREIGN KEY (parent_contact_id) REFERENCES parent_contacts(id),'
