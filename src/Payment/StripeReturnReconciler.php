...
final class StripeReturnReconciler
{
    ...
    public function reconcile(AuthenticatedParent $parent, int $paymentId, string $sessionId): void
    {
        ...
        // Zahlungen zu bereits bestehenden Buchungen werden vom dafür vorgesehenen
        // BookingDueStripePaymentService verarbeitet. Dieser Reconciler ist nur das
        // Sicherheitsnetz für Reservierungen, die noch in eine Buchung umgewandelt werden müssen.
