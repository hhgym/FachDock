...
<main class="shell stack"><header class="hero"><span class="eyebrow">Konfiguration</span><h1>Buchungen</h1><p>Zeitgrenzen, Gebühren und Vorschlagsparameter des Buchungsworkflows.</p></header>
...
<label>Standard-Jahresbeitrag in €<input name="default_annual_fee" inputmode="decimal" value="<?= $e($defaultAnnualFee) ?>" required><small>Wird für automatisch neu angelegte Schuljahre übernommen. Bestehende Schuljahre und Buchungen bleiben unverändert.</small></label>
